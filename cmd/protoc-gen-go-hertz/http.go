...
const (
	...
	hertzAppPackage    = protogen.GoImportPath("github.com/cloudwego/hertz/pkg/app")
	hertzServerPackage = protogen.GoImportPath("github.com/kanengo/ktp/transport/hertz")
	// hertzClientPakcage    = protogen.GoImportPath("github.com/cloudwego/hertz/pkg/app/client")
	hertzConfigPakcage    = protogen.GoImportPath("github.com/cloudwego/hertz/pkg/common/config")
	hertzProtocolPackagae = protogen.GoImportPath("github.com/cloudwego/hertz/pkg/protocol")
	hertzConstPacckage    = protogen.GoImportPath("github.com/cloudwego/hertz/pkg/protocol/consts")
)
...
func generateFile(gen *protogen.Plugin, file *protogen.File, omitempty bool, omitemptyPrefix string) *protogen.GeneratedFile {
	...
	g.P("// versions:")
	g.P(fmt.Sprintf("// - protoc-gen-go-hertz %s", release))
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool, omitemptyPrefix string) {
	...
	g.P("var _ = new(", hertzAppPackage.Ident("RequestContext"), ")")
	g.P("var _ = new(", hertzServerPackage.Ident("Server"), ")")
	g.P("var _ = new(", hertzServerPackage.Ident("Client"), ")")
	g.P("var _ = new(", hertzConfigPakcage.Ident("RequestOption"), ")")
	g.P("var _ = new(", hertzProtocolPackagae.Ident("Request"), ")")
	g.P("var _ = ", hertzConstPacckage.Ident("StatusOK"))
	g.P()

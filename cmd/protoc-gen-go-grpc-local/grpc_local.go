...
func (serviceGenerateHelper) generateClientStruct(g *protogen.GeneratedFile, clientName string) {
	...
	g.P("impl ", grpcPackage.Ident("ClientConnInterface"))
	g.P("}")
	g.P()
}
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	filename := file.GeneratedFilenamePrefix + "_grpc_local.pb.go"
	...
	g.P("// Code generated by protoc-gen-go-grpc-local. DO NOT EDIT.")
	g.P("// versions:")
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	// Client interface.
	clientName := service.GoName + "ClientLocal"
	...
	g.P("func New", clientName, " (impl ", service.GoName+"Server", ") ", service.GoName+"Client", " {")
	g.P("return &", unexport(clientName), "{impl}")
...
func genClientMethod(_ *protogen.Plugin, _ *protogen.File, g *protogen.GeneratedFile, method *protogen.Method, index int) {
	...
	g.P("func (c *", unexport(service.GoName), "ClientLocal) ", clientSignature(g, method), "{")
	// g.P("cOpts := append([]", grpcPackage.Ident("CallOption"), "{", grpcPackage.Ident("StaticMethod()"), "}, opts...)")
	if !method.Desc.IsStreamingServer() && !method.Desc.IsStreamingClient() {
		g.P("return ", "c.impl.", method.GoName, "(ctx, in)")
